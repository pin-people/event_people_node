...
class RabbitContext {
    ...
    retryCount;
    retryManager;
    constructor(channel, message, queueName, maxRetries, initialDelay, delayStrategy, retryCount, dlqName) {
        ...
        this.retryManager = new retry_manager_1.RetryManager(maxRetries, delayStrategy, initialDelay);
    }
    /**
    ...
    deadLetter() {
        ...
        try {
            const published = this.channel.publish('', this.dlqName, Buffer.from(this.message.content), {
                persistent: true,
